            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <h4 class="mt-2 fw-bold">Basic Details</h4>
                        <div class="row g-3 mt-1 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="internet_status"
                                    ...
                                    <option value="active" {{ old('internet_status') == 'active' ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="inactive" {{ old('internet_status') == 'inactive' ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
                        ...
                        <h4 class="fw-bold">Communication Details</h4>
                        <div class="row g-3 mt-1 mb-4">
                        ...
                        <h4 class="fw-bold">Plan Details</h4>
                        <div class="row g-3 mt-1">

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Internet Speed</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bandwidth"
                                    class="form-control @error('bandwidth') is-invalid @enderror" value="Unlimited"
                                    readonly>
                                @error('bandwidth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="Router, Cable, Adapter" readonly>
