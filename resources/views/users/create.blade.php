            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3 mt-1 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="internet_status" class="form-select @error('internet_status') is-invalid @enderror" required>
                                ...
                                <option value="inactive" {{ old('internet_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        {{-- Bandwidth (Always Unlimited & Readonly) --}}
                        <div class="col-md-6">
...
<script>
    ...
    // Optional: Prevent invalid characters in coordinates
