                    ...
                    <div class="card-body">
                        <form action="{{ route('installations.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="installed_on" class="form-control fw-bold" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Comments</label>
                                <textarea name="comments" class="form-control" rows="2" placeholder="Enter Your Comments..."></textarea>
                            </div>
