                    ...
                    <form action="{{ route('tickets.update', $ticket->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('admin_remarks') is-invalid @enderror"
                                      name="admin_remarks" rows="2">{{ old('admin_remarks', $ticket->admin_remarks) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                ...
                                <option value="Pending"
                                    {{ old('status', $ticket->status) === 'Pending' ? 'selected' : '' }}>
                                    Pending
                                </option>

                                <option value="Irrelevant"
                                    {{ old('status', $ticket->status) === 'Irrelevant' ? 'selected' : '' }}>
                                    Irrelevant
                                </option>
